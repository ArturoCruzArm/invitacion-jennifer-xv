...
(function () {
    ...
    var EVENTO_SLUG   = 'invitacion-jennifer-xv';
    var SB_KEY        = 'invitacion_jennifer_xv_photo_selections';
    ...
    function mostrarBanner(sels) {
        ...
        banner.style.cssText = 'background:#4A0000;color:#FFD700;text-align:center;padding:12px 20px;font-size:.88rem;position:sticky;top:0;z-index:200;line-height:1.5;';
        banner.innerHTML = '📸 <strong>¡Tus fotos están listas!</strong> Aún no has seleccionado ninguna. ¡Empieza ahora! <button onclick="this.parentElement.remove()" style="margin-left:12px;background:transparent;border:1px solid #FFD700;color:#FFD700;padding:1px 8px;border-radius:4px;cursor:pointer;">✕</button>';
